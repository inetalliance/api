...
import com.callgrove.obj.FollowUpEmail;
import com.callgrove.obj.Opportunity;
import com.callgrove.obj.ProductLine;
import com.callgrove.obj.SentFollowUpEmail;
...
public class FollowUpEmailPerformance
  ...
  protected void get(final HttpServletRequest request, final HttpServletResponse response)
    ...
    Query<Opportunity> oppQuery = Opportunity.withSite(site)
        .and(Opportunity.withProductLine(productLine));
    if (source != null) {
      oppQuery = oppQuery.and(Opportunity.withSaleSource(source));
    }
    final Query<SentFollowUpEmail> query = SentFollowUpEmail.hasEmail
