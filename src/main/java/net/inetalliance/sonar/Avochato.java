...
public class Avochato {
  ...
  public final JsonList searchContacts(final Opportunity opportunity)
    throws IOException, URISyntaxException, UnrecoverableKeyException, NoSuchAlgorithmException,
    ...
    final MultivalueMap<String, String> params =
      new CaseInsensitiveStringMultivalueMap<>(3);
    ...
    final URI uri = new URI("https", host, "/v1/contacts",
      UrlUtil.toQueryString(params), null);
    ...
    return JsonMap
      ...
      .map(json -> {
        ...
        return map.$("url",
          String.format("https://www.avochato.com/accounts/%s/contacts/%s",
            site.getAvochatoKey(),
            map.get("id")));
      })
